...
**Goal:** Fix all 34 TypeScript errors in the 11 umb pattern test files so that `npm run typecheck:extensions` exits with zero errors for pattern tests.
**Demo:** npm run typecheck:extensions exits with zero errors for all 11 umb pattern test files
...
- [x] **T01: Fix vitest imports, .js extensions, and implicit any types in all 11 pattern test files** `est:30m`
...
3. **TS7006 (12 errors)**: Add type annotations to callback parameters in 3 files:
  ...
  - Files: `src/resources/extensions/umb/patterns/__tests__/agent-babysitter.test.ts`, `src/resources/extensions/umb/patterns/__tests__/architect-editor-split.test.ts`, `src/resources/extensions/umb/patterns/__tests__/atlas-hook.test.ts`, `src/resources/extensions/umb/patterns/__tests__/background-manager.test.ts`, `src/resources/extensions/umb/patterns/__tests__/error-retry.test.ts`, `src/resources/extensions/umb/patterns/__tests__/file-augmented-retrieval.test.ts`, `src/resources/extensions/umb/patterns/__tests__/lossless-context-management.test.ts`, `src/resources/extensions/umb/patterns/__tests__/sctdd.test.ts`, `src/resources/extensions/umb/patterns/__tests__/self-correction-loop.test.ts`, `src/resources/extensions/umb/patterns/__tests__/shadow-workspace.test.ts`, `src/resources/extensions/umb/patterns/__tests__/worktree-isolation.test.ts`
  - Verify: npx tsc --noEmit --project tsconfig.extensions.json 2>&1 | grep 'patterns/__tests__' | grep -c 'error TS' returns 0
