...
# T01: Replace .gsd symlink with real directory and configure git tracking
...
- `.gsd/ (real directory)`
- `.gitignore (updated with runtime-specific patterns)`
- `.gsd/PROJECT.md (staged)`
- `.gsd/REQUIREMENTS.md (staged)`
- `.gsd/DECISIONS.md (staged)`
- `.gsd/KNOWLEDGE.md (staged)`
- `.gsd/QUEUE.md (staged)`
- `.gsd/PRD.md (staged)`
- `.gsd/CODEBASE.md (staged)`
- `.gsd/RESEARCH.md (staged)`
- `.gsd/milestones/ (planning .md files staged)`
