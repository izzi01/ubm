...
const fixturesBySurface: Record<string, SecondaryParityFixtureDefinition[]> = {
  ...
  mcp: [
    ...
    },
    {
      ...
      surfaceId: "mcp",
      title: "Future representative MCP interaction recording",
      kind: "recording",
      status: "planned",
      path: "tests/fixtures/recordings/secondary-mcp-session.json",
      deterministic: true,
      purpose: "Reserved tracked recording path for a representative MCP interaction proof.",
  ...
  "workflow-bmad": [
    ...
    },
    {
      ...
      surfaceId: "workflow-bmad",
      title: "Future representative workflow/BMAD fixture",
      kind: "manifest",
      status: "planned",
      path: "tests/fixtures/secondary-workflow-bmad-manifest.json",
      deterministic: true,
      purpose: "Reserved tracked manifest path for one representative workflow/BMAD parity loop.",
