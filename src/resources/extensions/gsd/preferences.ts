...
/**
 * Resolve the effective git isolation mode.
 *
 * Always returns "worktree" — the only supported isolation mode.
 * The "none" and "branch" modes were deprecated and removed.
 */
export function getIsolationMode(): "worktree" {
  return "worktree";
}
